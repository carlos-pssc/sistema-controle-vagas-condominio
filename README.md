...
2. Abra o **Shell do XAMPP**, acesse o console do MySQL (utilizando o comando `mysql -u root`) e copie e cole os comandos SQL do seu arquivo de script (como o `banco.sql` na raiz deste repositório) para criar o banco de dados `a3`, as tabelas e os dados de teste automaticamente.
...
> 💡 **Credenciais de Teste:** Para realizar o primeiro login e testar o sistema, utilize o e-mail **`admin@email.com`** e a senha **`123456`** (dados de demonstração já incluídos automaticamente pelo script SQL).
